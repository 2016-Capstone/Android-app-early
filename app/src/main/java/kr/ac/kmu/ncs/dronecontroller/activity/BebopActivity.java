...
import kr.ac.kmu.ncs.dronecontroller.drone.BebopDrone;
import kr.ac.kmu.ncs.dronecontroller.view.BebopVideoView;
...
public class BebopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ARDiscoveryDeviceService service = intent.getParcelableExtra(Constants.EXTRA_DEVICE_SERVICE);
    ...
    private void initIHM() {
        mVideoView = (BebopVideoView) findViewById(R.id.video_view_background);
        ...
        mTakeOffLandBt = (Button) findViewById(R.id.btn_takeoff_or_land);
        mTakeOffLandBt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                switch (mBebopDrone.getmFlyingState()) {
        ...
        mDownloadBt = (Button) findViewById(R.id.btn_download);
        ...
        mBatteryLabel = (TextView) findViewById(R.id.lb_battery);
    }
    ...
    private final BebopDrone.Listener mBebopListener = new BebopDrone.Listener() {
        ...
        @Override
        public void onBatterChargeChanged(int batteryPercentage) {
        ...
        public void onPilotingStateChanged(ARCOMMANDS_ARDRONE3_PILOTINGSTATE_FLYINGSTATECHANGED_STATE_ENUM state) {
            switch (state) {
                case ARCOMMANDS_ARDRONE3_PILOTINGSTATE_FLYINGSTATECHANGED_STATE_LANDED: //  Landing state
                    mTakeOffLandBt.setText("Take off");
                    mTakeOffLandBt.setEnabled(true);
                    mDownloadBt.setEnabled(true);
                    break;
                case ARCOMMANDS_ARDRONE3_PILOTINGSTATE_FLYINGSTATECHANGED_STATE_FLYING: //  Flying state
                case ARCOMMANDS_ARDRONE3_PILOTINGSTATE_FLYINGSTATECHANGED_STATE_HOVERING:
        ...
        @Override
        public void onFrameReceiver(ARFrame frame) {
